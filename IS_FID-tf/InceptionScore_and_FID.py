...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', type=str, default='checkpoint/7.npy', help='samples with npy format')
    parser.add_argument('--stats', type=str, default='checkpoint/pre.npz', help='pre-calculated statistics')
