...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='DCGAN', choices=['GAN', 'DCGAN', 'WGAN-CP', 'WGAN-GP', 'SNGAN'])
    parser.add_argument('--is_train', type=str, default='True')
    parser.add_argument('--dataroot', default='../WGAN/cifar-10-batches-py', help='path to dataset')
    ...
    parser.add_argument('--generator_iters', type=int, default=40001, help='The number of iterations for generator in WGAN model.')
