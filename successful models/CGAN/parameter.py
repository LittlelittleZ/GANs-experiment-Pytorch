...
def getParameters():
    ...
    parser.add_argument('--gbatch_size', type=int, default=128)
    ...
    # Path
    parser.add_argument('--image_path', type=str, default='/home/baiqiujian/Desktop/SN_Cifar10/cifar-10')
    parser.add_argument('--log_path', type=str, default='../logs')
    parser.add_argument('--model_save_path', type=str, default='../checkpoint')
    parser.add_argument('--sample_path', type=str, default='../samples')
    parser.add_argument('--FID_mean_cov', type=str, default='/home/baiqiujian/Desktop/SN_Cifar10/cifar-10')
    ...
    parser.add_argument('--caculate_FID', type=str2bool, default=False)
